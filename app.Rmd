...
```{r, include=FALSE}
profvis({
clean_claims_21 <-read_stata("data/clean_claims_v4.dta")
...
```{r, include=FALSE}
profvis({
raw_claims_feb21 <-read_stata("data/raw_claims_feb21.dta")
...
fig <- fur_status_df %>% 
        plot_ly(labels = ~fur_status, values = ~n, marker = list(colors = c('#ff0000', '#00aa7f' ))) %>% 
...
fig <- fud_status_df %>% 
        plot_ly(labels = ~fud_status, values = ~n, marker = list(colors = c('#ff0000', '#00aa7f'))) %>% 
        add_pie(hole = 0.55, textfont = list(size = 13)) %>% 
        layout(showlegend = T,
                xaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE),
                yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
...
fig <- pde_status_df %>% 
        plot_ly(labels = ~pde_status, values = ~n, marker = list(colors = c('#ff0000', '#00aa7f'))) %>%
        add_pie(hole = 0.55, textfont = list(size = 13)) %>% 
        layout(showlegend = T,
                xaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE),
                yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
...
dictionary_surnames <- read_stata("data/dictionary_surnames.dta")
